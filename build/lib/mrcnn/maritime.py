...
class MaritimeConfig(Config):
    ...
    NUM_CLASSES = 8  # For background + my_classes
...
class MaritimeDataset(utils.Dataset):
    ...
    def load_maritime(self, dataset_dir, dataset_type):
        ...
        self.add_class("maritime", 4, "prises")
...
if __name__ == '__main__':
    ...
    dataset_train.load_maritime("/home/listic/Downloads/Maritme_Mask_RCNN (copy)/Train_own_dataset/maritime_dataset/", "training")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = MaritimeDataset()
    #dataset_val.load_maritime(args.dataset, "validation")
    dataset_val.load_maritime("/home/listic/Downloads/Maritme_Mask_RCNN (copy)/Train_own_dataset/maritime_dataset/", "validation")
    dataset_val.prepare()
