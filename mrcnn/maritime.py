...
class MaritimeConfig(Config):
    ...
    NUM_CLASSES = 10  # For background + my_classes
    ...
    # Image mean (RGB)
    MEAN_PIXEL = np.array([135.71361765122649, 125.46002919252717, 116.14267348956616])
...
class MaritimeDataset(utils.Dataset):
    ...
    def load_maritime(self, dataset_dir, dataset_type):
        ...
        """
        # Add classes
        self.add_class("maritime", 1, "porte")
        self.add_class("maritime", 2, "fenetre")
        self.add_class("maritime", 3, "lampe")
        self.add_class("maritime", 4, "prise")
        self.add_class("maritime", 5, "interrupteur")
        self.add_class("maritime", 6, "radiateur")
        self.add_class("maritime", 7, "baes")
        self.add_class("maritime", 8, "extincteur")
        #self.add_class("maritime", 5, "fenetre")
        self.add_class("maritime", 9, "controleur")
        #self.add_class("maritime", 9, "edi")
...
if __name__ == '__main__':
    ...
    dataset_train.load_maritime("/uds_data/listic/SmarterPlan/Codes/Train_own_dataset/maritime_dataset/", "trainingN")
    ...
    dataset_val.load_maritime("/uds_data/listic/SmarterPlan/Codes/Train_own_dataset/maritime_dataset/", "validationN")
    dataset_val.prepare()
